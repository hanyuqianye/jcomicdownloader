...
public class Parse7Wenku extends ParseEightNovel {
    ...
    public Parse7Wenku() {
        ...
        indexName = Common.getStoredFileName( SetUp.getTempDirectory(), "index_7wenku_parse_", pageExtension );
        indexEncodeName = Common.getStoredFileName( SetUp.getTempDirectory(), "index_7wenku_encode_parse_", pageExtension );

        jsName = "index_7wenku.js";
        radixNumber = 1512841; // default value, not always be useful!!

        baseURL = "http://www.7wenku.com";
    }
    ...
    private void downloadIllustrations( String allPageString ) {
        ...
        String picBaseURL = "http://www.7wenku.com/files/article/attachment/";
