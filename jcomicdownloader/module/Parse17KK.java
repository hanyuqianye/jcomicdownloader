...
public class Parse17KK extends ParseOnlineComicSite {
    ...
    private String getRealPicURL( String url ) {
        url = url.replace( "www.17kk.net", "image.17kkmh.com/image1.17kk" );
        url = url.replace( "image.17kk.net", "image.17kkmh.com/image1.17kk" );
        url = url.replace( "image3.17kk.net", "image.17kkmh.com/image3.17kk" );

        url = url.replace( "image4.17kk.net", "image.17kkmh.com/image6.17kk" );
        url = url.replace( "image6.17kk.net", "image.17kkmh.com/image6.17kk" );
        url = url.replace( "image0.17kk.net", "image.17kkmh.com/image0.17kk" );
        url = url.replace( "image2.17kk.net", "image.17kkmh.com/image2.17kk" );

        url = url.replace( "image7.17kk.net", "image.17kkmh.com/image7.17kk" );
        url = url.replace( "comiclist.17kk.net", "image.17kkmh.com" );
