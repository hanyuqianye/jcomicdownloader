...
public class BackgroundSettingFrame extends JFrame
    ...
    private void setBackgroundPicPanel( JPanel panel ) {
        ...
        backgroundPicButton = getButton( "選擇新的背景圖片" );
        ...
        choiceOtherDefaultColorButton = getButton( "選擇一般介面的正常字體顏色" );
        ...
        choiceOtherMouseEnteredColorButton = getButton( "選擇一般介面被滑鼠碰觸時的字體顏色" );
        ...
        if ( whichFrame == FrameEnum.MAIN_FRAME
            ...
            choiceTableDefaultColorButton = getButton( "選擇表格內容的正常字體顏色" );
            ...
            choiceTableMouseEnteredColorButton = getButton( "選擇表格內容被滑鼠碰觸時的字體顏色" );
        ...
        if ( whichFrame == FrameEnum.CHOICE_FRAME ) {
            choiceTableFileExistedColorButton = getButton( "選擇表格裡面已下載集數的字體顏色" );
        ...
        if ( whichFrame == FrameEnum.MAIN_FRAME ) {
            choiceMenuItemDefaultColorButton = getButton( "選擇右鍵選單的正常字體顏色" );
